...
const Schema: z.ZodType<Prisma.PersonUpdateManyWithWhereWithoutResourceInput> =
  z
    .object({
...
export const PersonUpdateManyWithWhereWithoutResourceInputObjectSchema = Schema;
