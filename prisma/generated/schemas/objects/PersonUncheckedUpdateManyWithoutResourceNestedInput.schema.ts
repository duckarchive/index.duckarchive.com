...
const Schema: z.ZodType<Prisma.PersonUncheckedUpdateManyWithoutResourceNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => PersonUpdateManyWithWhereWithoutResourceInputObjectSchema,
          ),
          z
            .lazy(
              () => PersonUpdateManyWithWhereWithoutResourceInputObjectSchema,
...
export const PersonUncheckedUpdateManyWithoutResourceNestedInputObjectSchema =
  Schema;
