...
const Schema: z.ZodType<Prisma.PersonUncheckedCreateNestedManyWithoutResourceInput> =
  z
    .object({
      create: z
        .union([
...
export const PersonUncheckedCreateNestedManyWithoutResourceInputObjectSchema =
  Schema;
