...
const Schema: z.ZodType<Prisma.PersonUncheckedUpdateManyWithoutAuthorNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => PersonUpsertWithWhereUniqueWithoutAuthorInputObjectSchema,
          ),
          z
            .lazy(
              () => PersonUpsertWithWhereUniqueWithoutAuthorInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => PersonUpdateWithWhereUniqueWithoutAuthorInputObjectSchema,
          ),
          z
            .lazy(
              () => PersonUpdateWithWhereUniqueWithoutAuthorInputObjectSchema,
...
export const PersonUncheckedUpdateManyWithoutAuthorNestedInputObjectSchema =
  Schema;
