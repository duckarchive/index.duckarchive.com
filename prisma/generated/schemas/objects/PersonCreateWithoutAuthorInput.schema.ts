import { z } from 'zod';
import { ResourceCreateNestedOneWithoutPersonsInputObjectSchema } from './ResourceCreateNestedOneWithoutPersonsInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.PersonCreateWithoutAuthorInput> = z
  .object({
    first_name: z.string(),
    ...
    resource: z.lazy(
      () => ResourceCreateNestedOneWithoutPersonsInputObjectSchema,
    ),
  })
  .strict();

export const PersonCreateWithoutAuthorInputObjectSchema = Schema;
