...
const Schema: z.ZodType<Prisma.PersonUpdateManyWithWhereWithoutAuthorInput> = z
  .object({
...
export const PersonUpdateManyWithWhereWithoutAuthorInputObjectSchema = Schema;
